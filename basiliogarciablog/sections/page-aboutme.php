...
get_header(); ?>
    <div class="about-me">
        <div>
            ...
            Además de mi amor por el código, tengo una gran admiración por la cultura y las tradiciones de mi tierra natal, lo cual influye en mi trabajo y mi forma de ver el mundo.
            A través de este blog, quiero compartir mis conocimientos, experiencias y las últimas tendencias en el desarrollo web. Espero que encuentres útil y emocionante lo que tengo para ofrecer,
    ...
    <ul>
        <li>Me podéis encontrar en:</li>
        <li>Twitter: _basiliogarcia_</li>
        <li>YouTube: @BasilioGarcia (próximamente)</li>
        <li>Fediverso: @basilioGarcia@tu.social</li>
    </ul>
<?php get_footer(); ?>
